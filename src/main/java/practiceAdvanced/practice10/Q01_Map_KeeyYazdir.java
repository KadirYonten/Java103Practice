...
public class Q01_Map_KeeyYazdir {
    ...
    */
    public static void main(String[] args) {
        ...
        //Map ten key ve value alabilmek icin entrySet() kullanabiliriz.Index gerektirdigi icin..
        for (Map.Entry<String, Double> w : urunler.entrySet()) {
            if (w.getValue() == 29.99) {
                System.out.println(w.getKey() + "--->" + w.getValue());
            }
//key ve value beraber iliskili olacaksa entrySet kullanmak en kolayidir
        }

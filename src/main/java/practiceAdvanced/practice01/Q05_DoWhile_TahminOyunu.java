...
public class Q05_DoWhile_TahminOyunu {
    ...
    public static void main(String[] args) {
        ...
        int sayi;
        int rastgeleSayi = (int)(Math.random()*100)+1;  // Random Class herzaman 0 ile 1 arasinda bir sayi verir bunun icin
                                                        // +1 ile toplariz ki bir tam sayi versin!!
        System.out.println(rastgeleSayi);
        int sayac = 0;


        do {                // do-while sectik oyuna ilk giriste tahminden önce kullaniciya msj.verdik..
            System.out.println("1-100 arası bir sayı tahmini giriniz");
            sayac++;        // Kullaniciya 10 hak vermek icin denemelerini saymamiz gerekli..
            sayi = input.nextInt();
        ...
        }while (sayi!=rastgeleSayi);    // Do-While döngüsü eger parantez icindeki sart dogruysa devam eder.. while (true) olmalidir..!
    }
}